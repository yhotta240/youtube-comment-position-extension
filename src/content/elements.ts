...
export const getElements = (): YoutubeElements => ({
  ...
  belowBoxes: document.querySelectorAll<HTMLElement>("#below .box.style-scope.ytd-watch-flexy"),
  belowFirstBox: document.querySelectorAll<HTMLElement>("#below .box.style-scope.ytd-watch-flexy")?.[0] ?? null,
  belowSecondBox: document.querySelectorAll<HTMLElement>("#below .box.style-scope.ytd-watch-flexy")?.[1] ?? null,
});
